...
def res_vis():
    with open('./data/comp3d-20-v2/agent_plan','rb') as f:
        agent_plan = pickle.load(f)

    with open('./data/comp3d-20-v2/agent_state','rb') as f:
        agent_state = pickle.load(f)

    with open('./data/comp3d-20-v2/agent_tube', 'rb') as f:
        agent_tube, agent_tube_cached, agent_tube_plan, agent_tube_time, agent_tube_result = pickle.load(f)

    with open('./data/comp3d-20-v2/comp3d-20-v2.json', 'r') as f:
