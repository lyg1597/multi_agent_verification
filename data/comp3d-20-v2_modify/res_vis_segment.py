...
def res_vis():
    ...
    for key in agent_tube_time:
        agent_tube[key] = [agent_tube[key][i] for i in range(1,len(agent_tube[key]),2)]
        agent_tube_cached[key] = [agent_tube_cached[key][i] for i in range(1,len(agent_tube_cached[key]),2)]
        agent_tube_plan[key] = [agent_tube_plan[key][i] for i in range(1,len(agent_tube_plan[key]),2)]
        agent_tube_time[key] = [agent_tube_time[key][i] for i in range(1,len(agent_tube_time[key]),2)]
        agent_tube_result[key] = [agent_tube_result[key][i] for i in range(1,len(agent_tube_result[key]),2)]
    ...
    for time_val_idx in range(len(time_val_list)):
        ...
        if plot_tubes:
            for j in range(time_val_idx-4, time_val_idx+1):
