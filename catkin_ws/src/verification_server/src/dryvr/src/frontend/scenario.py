...
from dryvr.src.backend.initialset import InitialSet
import json



class Scenario:
    def __init__(self, scenario_file_name: str = "", scenario = {}):
        assert (scenario_file_name != "" or scenario != {}), "Please provide input scenario"
        if scenario != {}:
            self.parse_scenario(scenario)
        elif scenario_file_name != "":
