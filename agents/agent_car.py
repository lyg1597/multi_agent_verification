...
class AgentCar:
    ...
    def execute_plan(self):
        ...
        for i in range(len(self.waypoint_list)):
            ...
            trace = TC_Simulate(current_plan.mode_parameters, curr_init_set, current_plan.time_bound)
...
if __name__ == "__main__":
    ...
    wp = [
        ...
        Waypoint('follow_waypoint',[20.4142135623735, 0.4142135623721741, 20.4142135623735, 10.4142135623721668],3.0,0),
        Waypoint('follow_waypoint',[20.4142135623735, 0.4142135623721741, 20.4142135623735, 15.4142135623721668],3.0,0),
        Waypoint('follow_waypoint',[20.4142135623735, 0.4142135623721741, 25.4142135623735, 15.4142135623721668],3.0,0),
        Waypoint('follow_waypoint',[20.4142135623735, 0.4142135623721741, 30.4142135623735, 15.4142135623721668],3.0,0),
    ]
